...
require (
	...
	github.com/leapforce-libraries/go_google v0.0.0-20210423214553-0375c4164934
	github.com/leapforce-libraries/go_googlecloudstorage v0.0.0-20210428214243-6426fdc85ebc
